...
// Placer ici les adresses respectives de chaque carte électronique
#define BROADCAST_ADDR				0xFF
#define NOT_SPECIFIED_ADDR			0x00
#define DASHBOARD_ADDR				0x01
#define STEARING_WHEEL_ADDR			0x02
#define GATEWAY_ADDR				0x03
